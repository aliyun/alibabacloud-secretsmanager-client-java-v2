...
import com.aliyuncs.kms.secretsmanager.client.v2.utils.AES256Utils;
import com.aliyuncs.kms.secretsmanager.client.v2.utils.ArrayUtils;
import com.aliyuncs.kms.secretsmanager.client.v2.utils.CacheClientConstant;
import com.aliyuncs.kms.secretsmanager.client.v2.utils.JsonIOUtils;
...
public class FileCacheSecretStoreStrategy implements CacheSecretStoreStrategy {
    ...
    private final Set<String> reloadedSet = new HashSet<>();
