...
public class FullJitterBackoffStrategy implements BackoffStrategy {
    ...
    public void init() throws CacheSecretException {
        this.retryMaxAttempts = this.retryMaxAttempts == null ? CacheClientConstant.DEFAULT_RETRY_MAX_ATTEMPTS : this.retryMaxAttempts;
        this.retryInitialIntervalMills = this.retryInitialIntervalMills == null ? CacheClientConstant.DEFAULT_RETRY_INITIAL_INTERVAL_MILLS : this.retryInitialIntervalMills;
        this.capacity = this.capacity == null ? CacheClientConstant.DEFAULT_CAPACITY : this.capacity;
    }
